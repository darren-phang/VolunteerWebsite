        ...
        <div class="container">
            <div class="wrapper">
                <div class="grid3 first">
                    <ul class="categories">
                        <li><a href="#" name="one" onmouseenter=""><%=lagetitle[0]%></a></li>
                        <li><a href="#" name="tow" onmouseenter=""><%=lagetitle[1]%></a></li>
                        <li><a href="#" name="three" onmouseenter=""><%=lagetitle[2]%></a></li>
                        <li><a href="#" name="four" onmouseenter=""><%=lagetitle[3]%></a></li>
                        <li><a href="#" name="five" onmouseenter=""><%=lagetitle[4]%></a></li>
                        <li><a href="#" name="six" onmouseenter=""><%=lagetitle[5]%></a></li>
                        <li><a href="#" name="seven" onmouseenter=""><%=lagetitle[6]%></a></li>
                        <li><a href="#" name="eight" onmouseenter=""><%=lagetitle[7]%></a></li>
                        <li><a href="#" name="nine" onmouseenter=""><%=lagetitle[8]%></a></li>
                    </ul>
                </div>
                <div class="grid9">
                    <h2><%=titlemore[showindex]%></h2>
                    <p><%=body[showindex]%></p>
                    <p><a href=<%=readmore[showindex]%> class="more">了解更多</a></p>
...
<footer>
    <div class="container">
        <div class="wrapper">
            <div class="copy">Industrial Services (c) 2018 | <a href="index-4.html">Privacy policy</a></div>
            <address class="phone">
