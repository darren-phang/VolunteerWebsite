...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            return window.open(aa,'','height=20,width=100,top=0,left=0,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');

        }

        function sentmessage() {
            var title = title.text.toString();
            var article = article.text.toString();
            var image_url = "";
            var vedio_url = "";
            openwindow("insetDatabase.jsp?title="+title+"article")
        }
    </script>
</head>
<body>
            ...
            <div class="clearfix">
                <div class="grid9">
                    ...
                    <form action="" name="title_form">
                        ...
                        <form action="UploadHandle" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <a href="javascript:;" class="file">
                                上传文件
                                <input type="file" name="uploadfile" style="color: black" >
                            </a>
                            <br/>
                            <br/>
