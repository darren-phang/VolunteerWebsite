        ...
        <div class="container">
            <div class="wrapper">
                <div class="grid3 first">
                    <ul class="categories">
                        <li><a href="#"><%=lagetitle[0]%></a></li>
                        <li><a href="#"><%=lagetitle[1]%></a></li>
                        <li><a href="#"><%=lagetitle[2]%></a></li>
                        <li><a href="#"><%=lagetitle[3]%></a></li>
                        <li><a href="#"><%=lagetitle[4]%></a></li>
                        <li><a href="#"><%=lagetitle[5]%></a></li>
                        <li><a href="#"><%=lagetitle[6]%></a></li>
                        <li><a href="#"><%=lagetitle[7]%></a></li>
                        <li><a href="#"><%=lagetitle[8]%></a></li>
                    </ul>
                </div>
                <div class="grid9">
                    <h2><%=titlemore[0]%></h2>
                    <p><%=body[0]%></p>
                    <p><a href=<%=readmore[0]%> class="more">了解更多</a></p>
                    <section class="images">
                        <figure><a href="#"><img src=<%=imageUrl[0]%> alt=""></a></figure>
